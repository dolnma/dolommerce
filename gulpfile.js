...
// Bulk .scss path files in index.scss
gulp.task('scss-paths', function () {
    return gulp
        .src(paths.sass + '/*.scss')
        .pipe(bulkSass())
        .pipe(
            sass({
                includePaths: [paths.sass + '/*.scss']
            }))
...
gulp.task('dev', ['browser-sync', 'scss-paths', 'watch', 'scripts'], function () {});
...
gulp.task('styleguide:applystyles', function () {
    return gulp.src(paths.sass + '/theme.scss')
        .pipe(bulkSass())
        .pipe(sass({
            errLogToConsole: true
        }))
...
gulp.task('scripts', function () {
    var scripts = [
        paths.dev + '/js/single-product.js',
        paths.dev + '/js/flexslider.js',
        paths.dev + '/js/**/*'
    ];
    gulp.src(scripts)
